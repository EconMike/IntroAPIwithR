...
#EIA data
# ba8c82f8966f3d937e106d98178b11a8

res <- GET('http://api.eia.gov/series/?series_id=ELEC.GEN.ALL-AK-99.A&api_key=ba8c82f8966f3d937e106d98178b11a8&out=json')
...
```{r census, echo=FALSE}
#census key
#e34b4f3569e898524b39c32a452511f673924728
...
library(rnoaa)
options(noaakey = "SihjOrlFmhXqetgorCMazZoWKZFbQGsR")
...
fredr_set_key("f9e9db126ec70b1b677f9b47db6040bf")
...
api_key<-"lPUnjTXlvCkwzf5KZsX3QElht"

api_secret<-"1f9pUXPhpuKsZlVCfgTCgoxOJOxsRZ66or7nlHNcg1NBXh0DUe"

access_token<-"1283546448966160387-nTMFynuN7uaw1DAHifWm24woIA4Lue"

access_token_secret<-"pX61L58nLkdZBz31QEtdtH3ngEcPcKGOzsLASmD5eDqfk"
...
app_name <- "LetslearnR"
key <- "lPUnjTXlvCkwzf5KZsX3QElht"
secret <-"1f9pUXPhpuKsZlVCfgTCgoxOJOxsRZ66or7nlHNcg1NBXh0DUe"
token<-"1283546448966160387-nTMFynuN7uaw1DAHifWm24woIA4Lue"
secreta<-"pX61L58nLkdZBz31QEtdtH3ngEcPcKGOzsLASmD5eDqfk" 
